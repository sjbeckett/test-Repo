...
# ╔═╡ 7d49a74e-ca53-11ef-36b4-353d7bb6df68
using OrdinaryDiffEqTsit5, PlotlyLight, PlutoUI, PlutoTeachingTools

# ╔═╡ 4972d782-e56e-4d8d-ba75-7868ddb6d49a
import PlutoUI: combine

# ╔═╡ 3b73f10a-4545-4784-b611-a687c3e48376
TableOfContents() 

# ╔═╡ 59a8998a-7b5f-41a1-aa54-4c660bd2bfe4
md"""
...
# ╔═╡ 103ff3c4-2d3f-4946-b772-546ad4c08a82
7*5

# ╔═╡ 4b53b23d-fdd1-4333-88a8-9b3ceb9862d8
md"""
...
# ╔═╡ f8ba7027-2825-45d5-86a0-9d7c723d8595
md"""
...
# ╔═╡ 8f6847d3-6627-432a-ad2e-917d222378d4
...
# ╔═╡ 69c953e2-c774-450f-9a81-b4499305f115
md"""
...
# ╔═╡ b337078e-314c-4401-bbdd-891dc5630292
begin
...
# ╔═╡ 55c10c31-64f3-41c8-bc86-3a446fea89f7
almost(
...
# ╔═╡ c5b2f341-18e8-43d7-b91a-74433237d7a9
...
# ╔═╡ daba9269-5ec2-4922-8661-63266e5c330a
@bind speeds epi_input(["β", "γ"])

# ╔═╡ 468fe95a-b5cb-487e-bbce-1c0dda5de8bc
begin
		#get disease parameters from sliders
		parameters = [speeds.β, speeds.γ]
	
		#set up the differential equation problem - we will solve numerically with Tsit5() - see more info: https://docs.sciml.ai/DiffEqDocs/stable/solvers/ode_solve/
		SIRproblem = ODEProblem(SIRmodel!, u0, tspan, parameters)
		solveSIR = solve(SIRproblem, Tsit5(), saveat=tres)
	
		#plotting - using the PlotlyLight package
...
# ╔═╡ c1130aa3-5eca-4183-98ce-bfdfd0a6ac20
...
# ╔═╡ 1666ef25-8268-400c-adcf-32800fb2734b


# ╔═╡ a0a75c03-c447-4a94-a048-481addc87151
md"""
...
# ╔═╡ bf794bd2-ca2e-4f79-81ee-2f5f240b0d87
md"""
# 3) Endemic outbreaks and waning immunity

"""

# ╔═╡ c951b3f8-e6c3-4141-90d9-6b680c514812
md"""
...
# ╔═╡ d8c4bc31-1bcb-485d-8bcc-c3cd34aff3dc
md"""
...
manifest_format = "2.0"
project_hash = "48d98d29ebd1b97f1c7814a2c2d85f4931423fa3"
...
[[deps.PlotlyLight]]
deps = ["Artifacts", "Cobweb", "Downloads", "EasyConfig", "JSON3", "Random"]
git-tree-sha1 = "ad771ff08bafe7c8a6ebabd67ae6fae5ea0a9f20"
