...
# ╔═╡ b5350540-be1b-11ef-150f-034f18b5420b
begin
	using OrdinaryDiffEq, Plots, PlutoUI
	import PlutoUI: combine
end

# ╔═╡ a55a731a-ed15-4675-8985-48bc4f09c401
md"""
...
# ╔═╡ fb33b6d5-92fe-4598-a81f-abd162834a43
7*5

# ╔═╡ 820881c9-dca2-4b60-979f-7499ef072586
md"""
...
# ╔═╡ 4df11c61-ef47-4a87-816f-e1a5a508ae8b
md"""
...
# ╔═╡ 3917255d-0fe3-4c79-98ec-3da212b150a8
...
# ╔═╡ 4159ae27-4ce8-4f35-9c24-1c192e43ee6e
md"""
...
# ╔═╡ c76defb3-53d7-42ab-871a-192a9bfed4f3
begin
...
# ╔═╡ b3d75486-d95c-46ee-9317-d5d1e1c622cc
	#@bind β Slider(0.01:0.01:2, default = 0.4, show_value=true)
#	@bind γ Slider(0.01:0.01:2, default = 0.1)

# ╔═╡ 767b3a3b-5637-4abc-924e-9e04abf5aa5f
function epi_input(directions::Vector)
	
	return combine() do Child
		
		inputs = [
			md""" $(name): $(
				Child(name, Slider(0.01:0.01:2.0, default = 0.4, show_value = true))
			)"""
...
# ╔═╡ a2d64e33-8af7-41d1-882e-8c9af7b0cdbf
@bind speeds epi_input(["β", "γ"])

# ╔═╡ 0350c330-cdf0-4401-8536-f41f42fd0e2e
begin
...
manifest_format = "2.0"
project_hash = "e7777fc1e2a92ed36f2d97f7b0bb7bd1e42d9c0c"
